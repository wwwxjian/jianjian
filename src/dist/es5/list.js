...
$(function () {
    ...
    */
    $(window).scroll(function () {
        var scrollTop = window.scrollY; //获取垂直滚动距离
    ...
    */
    ...
    $('#folio').on('click', 'li', function () {
        ...
        var shu = $(this).text(); // 点击的页数
        var url = '../api/list.php';
        var data = 'qty=20&page=' + shu;
        ajax('get', url, data, function (str) {
            var arr = JSON.parse(str);
    ...
    */
    // 下一页的封装
    function xia() {
        var shu = $('#folio .dik').text() * 1;
        var index = $('#folio .dik').index();
    ...
    function ajax_show(num1, num2) {
        ...
        var page = 1;
        var qty = 20;
        var url = '../api/sort.php';
        var data = 'type=' + type + '&from=' + from + '&page=' + page + '&qty=' + qty;
    ...
    */
    ...
    $('#goodslist').on('click', 'li p', function () {
        // console.log($(this).attr('date-id'));
        var id = $(this).parent().parent().attr('date-id');
    ...
    */
    ...
    $('#goodslist').on('click', '.car', function () {
        ...
        if (user) {
            ...
            var goodsColor = '红色';
            var goodsNum = 1;
            var goodsId = $(this).parent().parent().attr('date-id');
            // console.log(goodsId);
            var type = 'add';
            var url = '../api/car.php';
            var data = 'type=' + type + '&goodsid=' + goodsId + '&number=' + goodsNum + '&color=' + goodsColor;
            ajax('get', url, data, function (str) {
                var arr = JSON.parse(str);
                // console.log(arr);
            });
