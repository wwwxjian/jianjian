$(function(){
    ...
    */
    ...
    /*
        密码登录
    */
    $('#main .code .inp').focus(function(){  //聚焦
        $(this).css({
    ...
    $('#main .code .inp').blur(function(){  //失去焦点
    ...
    $('#username').blur(function(){
        ...
        if(user){
            ...
            ajax('get',url,data,function(str){
                // console.log(str);
                if(str == 'yes'){  //说明数据库中不存在该用户名
                    error('该用户名不存在');
                }
                if(str == 'no'){  //说明数据库中存在该用户名
                    right();
                }
            });
        }else{
    ...
    */
    $('#main .show .code div').click(function(){
        ...
        let data = `username=${username}&psw=${psw}`;
